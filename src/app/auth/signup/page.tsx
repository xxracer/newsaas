...
export default function SignUpPage() {
  ...
  const { signUp, signInWithGoogle } = useMockAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/studio/setup'); // Redirect to studio setup after signup
    } catch (err: any) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-50 to-white px-4 py-8">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="h-16 w-16 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-4 shadow-luxury">
            <Scissors className="h-8 w-8 text-white" />
          </div>
          <CardTitle className="text-2xl font-bold font-heading text-gray-900">Crear tu Cuenta</CardTitle>
          <CardDescription>Comienza tu prueba gratis de 14 días</CardDescription>
        </CardHeader>
        <CardContent>
